...
class PatternExtractor:
    ...
    def analyze(self):
        ...
        patterns = {
            "guidance": {
                "description": "Design Patterns derived from analyzing " + str(len(html_files)) + " existing pages.",
                "GOLDEN_FLOW": [
        ...
        self.output_path.write_text(json.dumps(patterns, indent=2, ensure_ascii=False), encoding='utf-8')
