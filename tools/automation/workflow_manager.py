...
class WorkflowManager:
    ...
    def generate_plan(self, lesson_name, raw_path):
        ...
        cmd = [sys.executable, str(PROJECT_ROOT / "beta-utilities/plan_refiner.py"), str(raw_path), str(output_plan)]
    ...
    def verify_result(self, lesson_name):
        ...
        cmd = [sys.executable, str(PROJECT_ROOT / "beta-utilities/verify_headless.py"), str(newest_file)]
