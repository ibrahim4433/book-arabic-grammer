...
# Read original
with open('C:/Users/ibrah/Documents/GitHub/book-arabic-grammer/styles/main.css', 'r', encoding='utf-8') as f:
    content = f.read()
...
import os
os.makedirs('C:/Users/ibrah/Documents/GitHub/book-arabic-grammer/new-style-options/v7', exist_ok=True)

# Write to target
with open('C:/Users/ibrah/Documents/GitHub/book-arabic-grammer/new-style-options/v7/main.css', 'w', encoding='utf-8') as f:
    f.write(content)
