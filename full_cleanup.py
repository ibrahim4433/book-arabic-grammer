...
arabic_parts = ["الْأَوَّلُ", "الثَّانِي", "الثَّالِثُ", "الرَّابِعُ", "الْخَامِسُ", "السَّادِسُ", "السَّابِعُ", "الثَّامِنُ", "التَّاسِعُ", "الْعَاشِرُ", "الْحَادِيَ عَشَرَ", "الثَّانِيَ عَشَرَ", "الثَّالِثَ عَشَرَ", "الرَّابِعَ عَشَرَ", "الْخَامِسَ عَشَرَ"]
...
lesson_files = [f for f in glob.glob('pages/*.html') if "TEMPLATE_" not in f and not os.path.basename(f).startswith('00.') and not os.path.basename(f).startswith('98.')]
