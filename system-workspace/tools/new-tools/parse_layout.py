...
"""
    ...
    if os.path.exists("pages/cover/front-cover.jpg"):
        accumulated_body_content += f'<div class="cover-page-wrapper"><img src="pages/cover/front-cover.jpg" alt="Front Cover"></div>'
    ...
    if os.path.exists("pages/cover/back-cover.jpg"):
        accumulated_body_content += f'<div class="cover-page-wrapper" style="break-after: auto;"><img src="pages/cover/back-cover.jpg" alt="Back Cover"></div>'
...
def walk_boxes(box, page_number, results):
    ...
    if hasattr(box, 'element_tag') and box.element_tag == 'h3':
        ...
        if hasattr(box, 'text'): text += box.text
