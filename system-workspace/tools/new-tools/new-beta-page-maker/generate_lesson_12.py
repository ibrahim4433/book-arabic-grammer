    ...
    # BLOCK 3: Sound Verb Types
    {
        ...
        "data": {
            ...
            "rows": [
                [
                    "السَّالِم",
                    "ما خَلَتْ أُصولُهُ مِنَ الهَمْزَةِ وَالتَّضْعِيفِ.",
                    '<span class="highlight-blue">كَتَبَ</span>، <span class="highlight-blue">جَلَسَ</span>، <span class="highlight-blue">فَهِمَ</span>',
                ],
                [
                    "المَهْمُوز",
                    "ما كانَ أَحَدُ أُصولِهِ هَمْزَةً.",
                    '<span class="highlight-red">أَمَرَ</span>، <span class="highlight-red">سَأَلَ</span>، <span class="highlight-red">لَجَأَ</span>',
                ],
                [
                    "المُضَعَّف",
                    "ما كانَ أَحَدُ أُصولِهِ مُشَدَّدًا (مُضَعَّفًا).",
                    '<span class="highlight-green">صَدَّ</span>، <span class="highlight-green">جَدَّ</span>، <span class="highlight-green">مَدَّ</span>',
                ],
            ],
        },
    },
    # BLOCK 4: Weak Verb Types
    {
        ...
        "data": {
            ...
            "rows": [
                [
                    "المِثَال",
                    "أَوَّلُهُ حَرْفُ عِلَّةٍ.",
                    '<span class="highlight-blue">وَصَلَ</span>، <span class="highlight-blue">وَجَدَ</span>، <span class="highlight-blue">يَئِسَ</span>',
                ],
                [
                    "الأَجْوَف",
                    "أَوْسَطُهُ (عَيْنُهُ) حَرْفُ عِلَّةٍ.",
                    '<span class="highlight-red">قَالَ</span>، <span class="highlight-red">صَامَ</span>، <span class="highlight-red">بَاعَ</span>',
                ],
                [
                    "النَّاقِص",
                    "آخِرُهُ (لَامُهُ) حَرْفُ عِلَّةٍ.",
                    '<span class="highlight-green">مَشَى</span>، <span class="highlight-green">دَنَا</span>، <span class="highlight-green">رَمَى</span>',
                ],
            ],
        },
    },
        ...
        "data": {
            ...
            "left_content": [
                ...
                },
                {
                    ...
                    "data": {
                        "items": [
                            '<span class="highlight-red">وَعَى</span>',
                            '<span class="highlight-red">وَشَى</span>',
                            '<span class="highlight-red">وَقَى</span>',
                        ],
            ...
            "right_content": [
                ...
                },
                {
                    ...
                    "data": {
                        "items": [
                            '<span class="highlight-blue">رَوَى</span>',
                            '<span class="highlight-blue">هَوَى</span>',
                            '<span class="highlight-blue">طَوَى</span>',
                        ],
                        "markers": ["مِثْل:", "مِثْل:", "مِثْل:"],
                    },
                },
...
def render_block_html(block):
    ...
    if b_type == "HEADER":
        ...
        for row in b_data["rows"]:
            ...
            row_map = {"[CELL_1]": row[0], "[CELL_2]": row[1], "[CELL_3]": row[2]}
        ...
        for i, item in enumerate(items):
            items_html += render_template(T_LIST_ITEM, {"[MARKER]": markers[i], "[CONTENT]": item})
        ...
        return render_template(template, {"[LIST_ITEMS]": items_html})
        ...
        template = template.replace(
            '<div class="exam-question" id="[Q1_ID]">',
            '<div class="exam-question mb-0 border-none pb-0" id="[Q1_ID]">',
        )
...
def verify_page_layout(html_content):
    ...
    try:
        result = subprocess.run(
            ["python", VERIFY_SCRIPT, temp_file], capture_output=True, text=True
        )
