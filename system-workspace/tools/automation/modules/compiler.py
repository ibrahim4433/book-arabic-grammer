...
class Compiler:
    ...
    def __init__(self, project_root=None, api_key=None):
        ...
        self.mappings_path = (
            self.project_root / "system-workspace/tools/automation/mappings/plan_to_template.json"
        )
    ...
    def parse_plan(self, plan_content):
        ...
        for i in range(1, len(parts), 2):
            ...
            blocks.append({"type": block_title, "component": component, "fields": fields})
    ...
    def compile_page(self, plan_path):
        ...
        wrapper_tpl = (self.templates_dir / "TEMPLATE_C_PAGE_WRAPPER.html").read_text(
            encoding="utf-8"
        )
    ...
    def _transform_table(self, tpl_content, markdown_table):
        ...
        return tpl_content.replace("[TABLE_HEADERS]", header_html).replace(
