...
def step_1_vision(client, image_path):
    ...
    parts = [{"text": prompt_text}, {"inline_data": {"mime_type": mime_type, "data": img_data}}]
    return client.generate(parts)


def step_2_plan(client, raw_text, current_state):
    print("🧠 [Architect] Generating Plan...")
...
def main():
    ...
    # Load state
    state_path = PROJECT_ROOT / "tools/automation/project_state.json"
