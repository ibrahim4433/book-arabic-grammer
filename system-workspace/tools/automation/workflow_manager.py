...
class WorkflowManager:
    ...
    def generate_plan(self, lesson_name, raw_path):
        ...
        cmd = [
            sys.executable,
            str(PROJECT_ROOT / "tools/automation/plan_refiner.py"),
            str(raw_path),
            str(output_plan),
        ]
    ...
    def execute_jules(self, lesson_name, plan_path):
        ...
        try:
            ...
            self.state.update_lesson(
                lesson_name, status=STATE_PENDING_JULES, session_id=session_name
            )
    ...
    def verify_result(self, lesson_name):
        ...
        cmd = [
            sys.executable,
            str(PROJECT_ROOT / "tools/automation/verify_headless.py"),
            str(newest_file),
        ]
    ...
    def run(self, lesson_name):
        ...
        temp_lesson_path = PROJECT_ROOT / "output/text-data/current_lesson.txt"
