...
class TestYouTubeTranscriber(unittest.TestCase):
    ...
    def test_resolve_urls_playlist(self, mock_ytdl):
        ...
        urls, is_playlist = self.transcriber.resolve_urls("https://www.youtube.com/playlist?list=xyz")
    ...
    def test_transcription_pipeline(self, mock_get, mock_post):
        ...
        self.transcriber.download_audio_stream = MagicMock(return_value=(str(fake_audio), "Mock Title"))
        ...
        # Run process_url
        out_path, title = self.transcriber.process_url("https://www.youtube.com/watch?v=123", sequence_n=1)
